...
abstract class AppLocalizations {
  ...
  /// Application title shown in the system app switcher and as the default header.
  ///
  /// In en, this message translates to:
  /// **'Blutdruck Tracker'**
  String get appTitle;

  /// Title of the first-launch medical disclaimer dialog.
  ///
  /// In en, this message translates to:
  /// **'Important notice'**
  String get disclaimerTitle;

  /// Canonical medical disclaimer body. Mirrors docs/specs/12-privacy-and-medical.md.
  ///
  /// In en, this message translates to:
  ...
  /// Confirmation button on the first-launch disclaimer dialog.
  ///
  /// In en, this message translates to:
  /// **'I understand'**
