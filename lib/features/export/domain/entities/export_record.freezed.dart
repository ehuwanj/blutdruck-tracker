...
mixin _$ExportRecord {
  ...
  DateTime get periodFrom => throw _privateConstructorUsedError;
  DateTime get periodTo => throw _privateConstructorUsedError;
...
class _$ExportRecordImpl implements _ExportRecord {
  ...
  @override
  String toString() {
    return 'ExportRecord(id: $id, format: $format, periodFrom: $periodFrom, periodTo: $periodTo, filePath: $filePath, createdAt: $createdAt)';
  }
...
abstract class _ExportRecord implements ExportRecord {
  const factory _ExportRecord({
    ...
    required final DateTime periodFrom,
    required final DateTime periodTo,
